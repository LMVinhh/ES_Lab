...
void app_main(void) {
    xTaskCreate(cyclic_task, "cyclic_task", configMINIMAL_STACK_SIZE, NULL, 1, NULL);
    xTaskCreate(acyclic_task, "acyclic_task", configMINIMAL_STACK_SIZE + 1024, NULL, 2, NULL);
}
